...
qual variável $X$ está relacionada a outras variáveis $X$ é fazer a regressão de cada $X_i$ contra as demais variáveis $X$ e calcular o $R^2$ correspondente.
...
Agora que constatamos um problema de multicolinearidade, que ações “corretivas” podemos tomar? Vamos reconsiderar nosso modelo original. Antes de mais nada, poderíamos expressar o PNB não em termos nominais, mas em termos reais, o que podemos fazer dividindo o PNB nominal pelo
