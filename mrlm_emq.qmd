...
leva ao sistema de equações normais, resultado central na teoria de mínimos quadrados [@montgomery2021]. A dedução analítica dessa minimização, via diferenciação matricial, pode ser encontrada no [Apêndice de Diferenciação Matricial](#derivadas-eqm).
