...
A transformação logarítmica em $X$ é apropriada quando a relação entre $E(Y \mid X)$ e $X$ apresenta comportamento de crescimento proporcional ou lei de potência.
...
$$
\log E(Y \mid X) = \log \alpha + \beta \log X.
$$
