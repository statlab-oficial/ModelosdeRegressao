...
\begin{center}
\includegraphics{reg_files/figure-pdf/unnamed-chunk-5-1.pdf}
\end{center}
...
\item
  ...
  \protect\includegraphics[height=0.7em]{/tmp/RtmpvKR7rT/file1f45a66efdc72.pdf}
\item
  \(Var(\widehat{\boldsymbol{\beta}}) = \sigma^2 (\mathbf{X}^\top \mathbf{X})^{-1}\).
  (Prove!)
  \protect\includegraphics[height=0.7em]{/tmp/RtmpvKR7rT/file1f45a461bd523.pdf}
\item
