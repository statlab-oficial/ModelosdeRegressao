...
\$\$R\^{}2 = \frac{SQReg}{SQT} = \frac{S_{XY}^2}{S_{XX}S_{YY}} =
b\left(\frac{S_{XY}}{S_{YY}}\right).
...
\item
  ...
  \protect\includegraphics[height=0.7em]{/tmp/Rtmp6588IZ/file15cdb614076da.pdf}
\item
  \(Var(\widehat{\boldsymbol{\beta}}) = \sigma^2 (\mathbf{X}^\top \mathbf{X})^{-1}\).
  (Prove!)
  \protect\includegraphics[height=0.7em]{/tmp/Rtmp6588IZ/file15cdb3fe16773.pdf}
\item
